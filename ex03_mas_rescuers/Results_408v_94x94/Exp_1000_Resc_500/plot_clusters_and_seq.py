...
env_file = os.path.join(data_folder, "env_config.txt")                       # the program concatenates data_folder + env_file
obst_file = os.path.join(data_folder, "env_obst.txt")                       # the program concatenates data_folder + obst_file                      
victims_file = os.path.join(data_folder, "env_victims.txt"  )                # the program concatenates data_folder + victims_file   
vital_signals_file = os.path.join(data_folder, "env_vital_signals.txt" )     # the program concatenates data_folder + vsignal_file
